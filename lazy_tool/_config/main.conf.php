...
$config['VIEW_ALWAYS_COMPILE'] = true;
...
//Framework path
$config['FRAMEWORK_PATH'] = dirname($config['BASE_PATH']).'/_lazybones/';
 ...
 *-----------------------------------------------------------------------------------------------------------*/
//Site URL
$config['BASE_URL'] ='http://'.$_SERVER['HTTP_HOST'].''.$config['SUBFOLDER'];
...
//Site short URL
$config['BASE_SHORT_URL'] = ''.$config['SUBFOLDER'];
 ...
 * Project 設定
 *-----------------------------------------------------------------------------------------------------------*/
$config['app_model_path'] = dirname($config['BASE_PATH']).'/_app/model/';
